...
const Chats = () => {
  ...
  return (
    <div className="chats">
      {chats !== 'start conversation' && chats !== ''?Object.entries(chats).sort((a,b) => b[1].date - a[1].date).map((chat) => 
      ...
      ) : <span style={{color:"white", textAlign:"center", fontSize:"20px"}}><em>Welcome!Start your first conversation by searching users</em></span>}
    </div>
  )
}
